...
-- 17. Seed Real Corporate Engineers & Squad Direct Reports per Company
-- Allows Managers to immediately inspect and manage live direct reports in their squad
INSERT INTO public.profiles (emp_id, full_name, preferred_name, handle, department, role_title, role_level, company_name, company_domain, corporate_email, user_type, total_xp, is_signed, avatar_url)
VALUES
  -- Stripe Engineers
  ('WD-STRIPE-101', 'Elena Vasquez', 'Elena', 'elena.vasquez', 'engineering', 'Full Stack Engineer (Payments)', 'LEVEL 2 · MID-LEVEL', 'Stripe', 'stripe.corp', 'elena.vasquez@stripe.corp', 'employee', 320, true, 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&auto=format&fit=crop&q=80'),
  ('WD-STRIPE-102', 'Liam Gallagher', 'Liam', 'liam.gallagher', 'engineering', 'Distributed Systems Engineer', 'LEVEL 2 · MID-LEVEL', 'Stripe', 'stripe.corp', 'liam.gallagher@stripe.corp', 'employee', 280, true, 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&auto=format&fit=crop&q=80'),
  ('WD-STRIPE-103', 'Priya Sharma', 'Priya', 'priya.sharma', 'engineering', 'Frontend Platform Engineer', 'LEVEL 1 · JUNIOR', 'Stripe', 'stripe.corp', 'priya.sharma@stripe.corp', 'employee', 210, true, 'https://images.unsplash.com/photo-1517841905240-472988babdf9?w=150&auto=format&fit=crop&q=80'),

  -- Linear Engineers
  ('WD-LINEAR-101', 'Mikko Korhonen', 'Mikko', 'mikko.korhonen', 'engineering', 'Frontend Performance Engineer', 'LEVEL 2 · MID-LEVEL', 'Linear', 'linear.app', 'mikko.korhonen@linear.app', 'employee', 310, true, 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&auto=format&fit=crop&q=80'),
  ('WD-LINEAR-102', 'Sophie Laurent', 'Sophie', 'sophie.laurent', 'engineering', 'Sync Engine & SQLite Architect', 'LEVEL 2 · MID-LEVEL', 'Linear', 'linear.app', 'sophie.laurent@linear.app', 'employee', 290, true, 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=150&auto=format&fit=crop&q=80'),

  -- Meta Engineers
  ('WD-META-101', 'Jason Wu', 'Jason', 'jason.wu', 'engineering', 'PyTorch Infrastructure Developer', 'LEVEL 2 · MID-LEVEL', 'Meta', 'meta.corp', 'jason.wu@meta.corp', 'employee', 340, true, 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=150&auto=format&fit=crop&q=80'),
  ('WD-META-102', 'Camila Santos', 'Camila', 'camila.santos', 'engineering', 'React Core & Web Performance', 'LEVEL 1 · JUNIOR', 'Meta', 'meta.corp', 'camila.santos@meta.corp', 'employee', 240, true, 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=150&auto=format&fit=crop&q=80'),

  -- Google Cloud Engineers
  ('WD-GOOGLE-101', 'Arjun Nambiar', 'Arjun', 'arjun.nambiar', 'engineering', 'Kubernetes Cluster Reliability Engineer', 'LEVEL 2 · MID-LEVEL', 'Google Cloud', 'google.corp', 'arjun.nambiar@google.corp', 'employee', 330, true, 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=150&auto=format&fit=crop&q=80'),
  ('WD-GOOGLE-102', 'Chloe Bennett', 'Chloe', 'chloe.bennett', 'engineering', 'BigQuery & Distributed Storage', 'LEVEL 1 · JUNIOR', 'Google Cloud', 'google.corp', 'chloe.bennett@google.corp', 'employee', 220, true, 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=150&auto=format&fit=crop&q=80'),

  -- Vercel Engineers
  ('WD-VERCEL-101', 'Nils Lindqvist', 'Nils', 'nils.lindqvist', 'engineering', 'Turbopack Compiler Engineer', 'LEVEL 2 · MID-LEVEL', 'Vercel', 'vercel.corp', 'nils.lindqvist@vercel.corp', 'employee', 350, true, 'https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?w=150&auto=format&fit=crop&q=80'),
  ('WD-VERCEL-102', 'Maya Rodriguez', 'Maya', 'maya.rodriguez', 'engineering', 'Next.js App Router Specialist', 'LEVEL 1 · JUNIOR', 'Vercel', 'vercel.corp', 'maya.rodriguez@vercel.corp', 'employee', 250, true, 'https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=150&auto=format&fit=crop&q=80'),

  -- Supabase Engineers
  ('WD-SUPABASE-101', 'Torsten Berg', 'Torsten', 'torsten.berg', 'engineering', 'PostgREST & Realtime Architect', 'LEVEL 2 · MID-LEVEL', 'Supabase', 'supabase.corp', 'torsten.berg@supabase.corp', 'employee', 315, true, 'https://images.unsplash.com/photo-1501196354995-cbb51c65aaea?w=150&auto=format&fit=crop&q=80'),
  ('WD-SUPABASE-102', 'Zara Al-Mansoor', 'Zara', 'zara.almansoor', 'engineering', 'PostgreSQL Storage Engine Specialist', 'LEVEL 1 · JUNIOR', 'Supabase', 'supabase.corp', 'zara.almansoor@supabase.corp', 'employee', 230, true, 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=150&auto=format&fit=crop&q=80')
